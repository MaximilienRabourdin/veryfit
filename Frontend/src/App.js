    ...
    <AuthWrapper>
      <Routes>
        ...
        <Route path="/fit/*" element={<FitLayout />}>
          ...
          <Route path="orders/:orderId/declaration-montage" element={<DeclarationMontagePreview />} />
        ...
        <Route path="/revendeur/*" element={<RevendeurLayout />}>
          ...
          <Route path="orders/:orderId/produits/:produitId" element={<FormulaireProduitPage />} />
          <Route path="orders/:orderId/step/:stepIndex" element={<EtapeFormulaireCE />} />
          <Route path="orders/:orderId/declaration-montage" element={<DeclarationMontageForm />} />
          <Route path="declaration-ce/:orderId" element={<DeclarationCEPreview />} />
          <Route path="controle-periodique/:productId" element={<ControlePeriodiqueForm />} />
          <Route path="signature" element={<SignaturePage />} />
        </Route>
  
        {/* Toutes les routes Carrossier */}
        <Route path="/carrossier/*" element={<CarrossierLayout />}>
          ...
          <Route path="orders/:orderId" element={<CarrossierOrderDetails />} />
          <Route path="orders/:orderId/produits/:produitId" element={<FormulaireCarrossierProduit />} />
          <Route path="orders/:orderId/step/:stepIndex" element={<EtapeFormulaireCECarrossier />} />
          <Route path="orders/:orderId/declaration-montage" element={<DeclarationMontageCarrossier />} />
          <Route path="declaration-ce/:orderId" element={<DeclarationCECarrossier />} />
        </Route>
