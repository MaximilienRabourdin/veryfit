          ...
          <div>
            ...
            <nav>
              <ul className="space-y-4">
                {[
                  { to: "/revendeur/dashboard", label: "Tableau de bord" },
                  { to: "/revendeur/orders", label: "Dossier CE" },
                  { to: "/revendeur/declaration-montage", label: "Déclaration de montage" },
                  { to: "/revendeur/controle-periodique", label: "Controle périodique" },
                ].map((link) => (
                  <li key={link.to}>
                    <NavLink
                      to={link.to}
